    ...
    if (f == "" || g == 0) {
        ...
        new Ajax.Request(habboReqPath + "/groups/actions/check_group_url", {
            ...
            onComplete: function (n, m) {
                var o = Dialog.createDialog("group-url-confirmation", L10N.get("Configuration du groupe"), "9003", 0, -1000, cancelGroupSettingsConfirmation);
                var l = Builder.node("a", {
                    href: "#",
                    className: "new-button"
                }, [Builder.node("b", L10N.get("Tu confirmes ?")), Builder.node("i")]);
                var p = Builder.node("a", {
                    href: "#",
                    className: "new-button"
                }, [Builder.node("b", L10N.get("Annuler")), Builder.node("i")]);
...
function confirmAndUpdateGroupSettings(b) {
    ...
    if (c != a) {
        ...
        Dialog.showConfirmDialog(L10N.get("group.settings.group_type_change_warning." + d[parseInt(c)]), {
            ...
            headerText: L10N.get("Configuratino du groupe"),
            buttonText: L10N.get("Tu confirmes ?"),
            cancelButtonText: L10N.get("Annuler")
        })
    } else {
        updateGroupSettings(b);
       // alert('ok');
    ...
    new Ajax.Request(habboReqPath + "/groups/actions/update_group_settings", {
        ...
        onComplete: function (c) {
            ...
            if (c.responseText.indexOf("group-settings-form") < 0) {
                Overlay.move("9002");
                b = Dialog.createDialog("group_settings_result", L10N.get("Groupe configuration"), "9003", 0, -1000, closeGroupSettings);
                b.style.zIndex = "9003"
            } else {
                Overlay.move("9001")
            }
...
var Discussions = {
    ...
    createTopic: function () {
        ...
        new Ajax.Updater("group-topiclist-container", habboReqPath+"/discussions/actions/newtopic/index.php", {
            method: "post",
            evalScripts: true,
            parameters: a,
            onComplete: function (c, b) {
